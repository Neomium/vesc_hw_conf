...
#define LED_RED_ON()			palSetPad(GPIOB, 3)
#define LED_RED_OFF()			palClearPad(GPIOB, 3)

// Override dead time. See the stm32f4 reference manual for calculating this value.
#define HW_DEAD_TIME_NSEC               660.0

// Slightly increased limits for avoiding false positives in detecting unbalanced current
...
#define NTC_TEMP(adc_ind)		hw_cs40_get_temp()
